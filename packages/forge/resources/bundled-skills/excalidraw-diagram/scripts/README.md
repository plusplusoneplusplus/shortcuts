...
1. **Create library directory**:
   ```bash
   mkdir -p skills/excalidraw-diagram/libraries/aws-architecture-icons
   ```
...
3. **Run the script**:
   ```bash
   python skills/excalidraw-diagram/scripts/split-excalidraw-library.py skills/excalidraw-diagram/libraries/aws-architecture-icons/
   ```
...
```
skills/excalidraw-diagram/libraries/aws-architecture-icons/
