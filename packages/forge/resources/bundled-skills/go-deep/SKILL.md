...
3. **Plan File Generation (Parallel Sub-Agents)**: Dispatch sub-agents to write numbered plan files (`001-*.md`, `002-*.md`, ...) to `{task-folder}/<feature>/<work>/` — each sub-agent explores the relevant code and enriches the plan
