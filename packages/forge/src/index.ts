...
export {
    ...
    type PullRequestAutoMerge as ProviderPullRequestAutoMerge,
    type AutoMergeState as ProviderAutoMergeState,
    type AutoMergeBlockedReason as ProviderAutoMergeBlockedReason,
