...
describe('barrel exports', () => {
    ...
    it('compileToWorkflow is importable from package index', async () => {
        const mod = await import('../../src/index');
        expect(typeof mod.compileToWorkflow).toBe('function');
    });

    it('detectFormat is importable from package index', async () => {
        const mod = await import('../../src/index');
        expect(typeof mod.detectFormat).toBe('function');
    });

    it('CompilerError is importable from package index', async () => {
        const mod = await import('../../src/index');
        expect(mod.CompilerError).toBeDefined();
    });
});
