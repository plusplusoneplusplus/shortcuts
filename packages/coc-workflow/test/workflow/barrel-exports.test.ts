...
describe('Workflow barrel exports from coc-workflow', () => {
    ...
    it('node executors are functions', () => {
        expect(typeof executeLoad).toBe('function');
        expect(typeof executeMerge).toBe('function');
        expect(typeof executeTransform).toBe('function');
    });

    it('cancellation and concurrency exports are defined', () => {
        expect(typeof ConcurrencyLimiter).toBe('function');
        expect(typeof WorkflowCancellationError).toBe('function');
        expect(typeof isWorkflowCancelled).toBe('function');
    });
