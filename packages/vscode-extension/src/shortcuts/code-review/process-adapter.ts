...
import type { RuleReviewResult, ReviewFinding as MRReviewFinding } from '@plusplusoneplusplus/forge';
...
export function createCodeReviewProcessTracker(
    ...
    metadata: CodeReviewMetadata
): import('@plusplusoneplusplus/forge').ProcessTracker & { groupId?: string; updateGroupStructuredResult(result: string): void } {
    ...
    return {
        ...
        completeGroup(
            gId: string,
            summary: string,
            stats: import('@plusplusoneplusplus/forge').ExecutionStats
        ): void {
