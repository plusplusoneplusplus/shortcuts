 ...
 * Wiki Server Factory
 *
 * Creates and manages a standalone HTTP server that serves the wiki with
 * interactive exploration capabilities. Copied from deep-wiki/src/server/index.ts
 * with imports adapted for CoC source layout.
 *
