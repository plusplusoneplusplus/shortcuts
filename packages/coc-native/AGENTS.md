...
- `cargo test --manifest-path packages/coc-native/rust/Cargo.toml -p coc-symbols-lsp` — the language server, unit tests plus the spawned-binary handshake suite.
