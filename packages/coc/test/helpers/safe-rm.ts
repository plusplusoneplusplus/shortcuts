 ...
 * Falls back to a warning (instead of throwing) when the directory is
 * still locked after all retries.
 */
 ...
 * Suitable for global teardown functions and async afterEach hooks.
 */
