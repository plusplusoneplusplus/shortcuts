 ...
 *
 * Component tests for the notes-git RepoGitTab.
 */
...
import { RepoGitTab } from '../../../../../src/server/spa/client/react/repos/RepoGitTab';
...
describe('RepoGitTab (notes-git)', () => {
    ...
    it('shows spinner when loading', () => {
        ...
        render(<RepoGitTab workspaceId="ws-1" />);
    ...
    // ── matchCommitsByIdentity re-export ─────────────────────────────

    it('re-exports matchCommitsByIdentity', async () => {
        const mod = await import('../../../../../src/server/spa/client/react/repos/RepoGitTab');
        expect(typeof mod.matchCommitsByIdentity).toBe('function');
    });
});
