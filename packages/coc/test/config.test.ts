    ...
    describe('getResolvedConfigWithSource', () => {
        ...
        it('should handle config with all fields overridden', () => {
            ...
            fs.writeFileSync(configPath, [
                ...
                '  askUser:',
                '    enabled: false',
                '  globalSystemPrompt: Always be concise.',
                'serve:',
                '  port: 9000',
                '  host: 127.0.0.1',
                '  dataDir: /tmp/coc',
                ...
                '  chatProviderSwitching: true',
                '  canvasHostApis: true',
                '  explorerEditorTabs: true',
                '  chatStyleSelector: true',
                '  defaultChatStyle: direct',
                '  chatStylePrompts:',
                '    human: overridden human prompt',
                'memoryPromotion:',
                '  batchSize: 25',
                '  timeoutMs: 80000',
                '  model: gpt-test',
            ...
            expect({
            ...
            }).toMatchInlineSnapshot(`
              {
                ...
                "sources": {
                  ...
                  "chat.globalSystemPrompt": "default",
                  ...
                  "features.chatFolders": "default",
                  "features.chatProviderSwitching": "default",
                  "features.chatStylePrompts": "default",
                  "features.chatStyleSelector": "default",
                  "features.commitChatLens": "default",
                  "features.commitChatLensDormantMode": "default",
                  "features.composerWordHint": "default",
                  "features.defaultChatStyle": "default",
                  "features.explorerEditorTabs": "default",
                  "features.focusedDiff": "file",
                  "features.gitCrossCloneCherryPick": "default",
                  "features.gitWorktreeExecution": "file",
