import type { ForEachItem, ForEachItemStatus } from './types';
...
export function normalizeForEachItems(rawItems: unknown): ForEachItem[] {
...
export function assertDraftInitialStatuses(items: ForEachItem[]): void {
