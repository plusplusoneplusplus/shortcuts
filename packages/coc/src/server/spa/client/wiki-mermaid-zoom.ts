 ...
 *
 * Ported from deep-wiki mermaid-zoom.ts.
 * Self-contained module with no external dependencies beyond DOM queries
 * on the `.mermaid-container` structure created by processMarkdownContent().
 */

export const MERMAID_MIN_ZOOM = 0.25;
export const MERMAID_MAX_ZOOM = 4;
