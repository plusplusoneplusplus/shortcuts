/**
 * Shared provider brand visuals for the AI-provider admin surfaces.
 *
 * The `aip-avatar` styled SVG icons, `PROVIDER_LABELS`, and the `ProviderAvatar`
 * component are used by both the AI Provider page (`AIProviderPage`) and the
 * Dreams provider-activity section (`ProviderActivitySection`). Keeping them in
 * one module means the two surfaces share a single source of truth instead of
 * duplicating the brand artwork.
 */
import type { AdminConcreteAgentProvider } from '@plusplusoneplusplus/coc-client';
