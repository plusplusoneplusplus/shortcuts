/**
 * RepoGitTab — Notes-git tab with left/right split layout.
 *
...
// Re-export matchCommitsByIdentity from its new home for backward compat
export { matchCommitsByIdentity } from './commit-utils';
