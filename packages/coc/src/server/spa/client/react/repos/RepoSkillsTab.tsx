/**
 * RepoSkillsTab — manage Agent Skills installed in .github/skills/
 */
...
interface RepoSkillsTabProps {
    workspaceId: string;
}

type InstallSource = 'bundled' | 'github';

export function RepoSkillsTab({ workspaceId }: RepoSkillsTabProps) {
    ...
    return (
        <div className="p-4 flex flex-col gap-4 h-full overflow-y-auto">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-sm font-semibold text-[#1e1e1e] dark:text-[#cccccc]">Skills</h2>
