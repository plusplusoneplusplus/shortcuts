...
export function QueueFollowUpButton(props: QueueFollowUpButtonProps) {
    ...
    return (
        <button
            ...
            disabled={disabled}
            className={cn(
                'shrink-0 inline-flex items-center gap-2 h-[34px] px-2 sm:px-3 rounded-md text-sm font-medium cursor-pointer transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0078d4]/50 disabled:opacity-50 disabled:cursor-not-allowed',
                steering
