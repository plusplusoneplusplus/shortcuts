...
function ExploreCacheFilesPanel() {
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Sub-tab: Raw / Consolidated */}
            <Card className="p-4">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                        <h3 className="text-sm font-semibold text-[#1e1e1e] dark:text-[#cccccc]">
                            {selectedLabel} — Explore Cache
                        </h3>
            ...
            {/* Raw entry viewer */}
            {rawEntryLoading && <div className="flex justify-center py-4"><Spinner /></div>}
            ...
            {consolidatedEntryLoading && <div className="flex justify-center py-4"><Spinner /></div>}
