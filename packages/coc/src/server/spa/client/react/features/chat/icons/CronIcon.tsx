/**
 * CronIcon — shared SVG glyph for cron/repeat indicators.
 *
...
export interface CronIconProps {
    className?: string;
    title?: string;
    'aria-hidden'?: boolean | 'true' | 'false';
}

export function CronIcon({ className, title, ...rest }: CronIconProps) {
    return (
        <svg
