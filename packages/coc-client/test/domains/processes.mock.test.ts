...
describe('ProcessesClient mock server contract', () => {
  ...
  it('serializes turn actions, pinned turn reads, resume launches, and forks', async () => {
    ...
    expectJsonRequest(mock.requests[0], 'PATCH', '/api/processes/proc%2F1/turns/2/pin', { pinned: true });
    expectJsonRequest(mock.requests[1], 'PATCH', '/api/processes/proc%2F1/turns/2/archive', { archived: true });
    expectJsonRequest(mock.requests[4], 'POST', '/api/processes/proc%2F1/fork', {}, { workspace: 'repo/a' });
  });
