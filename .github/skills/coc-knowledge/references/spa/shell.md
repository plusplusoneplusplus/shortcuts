...
suppresses location recording while replaying Back or Forward. Closing a file
prunes its locations without moving the history cursor or discarding a surviving
forward branch. Alt+Left, Alt+Right, and auxiliary mouse buttons 3/4 use the same
