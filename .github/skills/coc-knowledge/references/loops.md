...
| `packages/coc/src/server/spa/client/react/features/chat/LoopBadge.tsx` | Dashboard header badge showing active loop count |
...
- **`LoopBadge`** — Header badge showing active loop count. Visible only when `loopsEnabled`.
