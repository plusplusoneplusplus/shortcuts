...
| Long-Running Reliability | [long-running-reliability.md](references/long-running-reliability.md) | Bundled delivery skill, detached watchdog CLI, read-only probes, recovery safety boundaries |
